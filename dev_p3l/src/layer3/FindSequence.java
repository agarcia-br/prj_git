...
public class FindSequence {
	...
	public void initSearchedPatterns() {
		...
		StructuredPermL3 p;
		p = new StructuredPermL3(cicle,noflip, 0,"cicle;noflip(1/8)");
		finalPatterns.add(p);
		p = new StructuredPermL3(cicle,allflip, 0,"cicle;allflip(1/8)");
		finalPatterns.add(p);
		p = new StructuredPermL3(cicle,flip_01, 0,"cicle;flip_01(1/8)");
		finalPatterns.add(p);
		p = new StructuredPermL3(cicle,flip_12, 0,"cicle;flip_12(1/8)");
		finalPatterns.add(p);
		p = new StructuredPermL3(cicle,flip_23, 0,"cicle;flip_23(1/8)");
		finalPatterns.add(p);
		p = new StructuredPermL3(cicle,flip_30, 0,"cicle;flip_23(1/8)");
		finalPatterns.add(p);
		p = new StructuredPermL3(cicle,vert_flip, 0,"cicle;vert_flip(1/8)");
		finalPatterns.add(p);
		
		p = new StructuredPermL3(cicle,hori_flip, 0,"cicle;hori_flip(1/8)");
		finalPatterns.add(p);
	}
